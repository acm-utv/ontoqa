...
The LexInfo ontology extends the lemon model with more than 600 specific linguistic categories.It can be used to add properties to different forms of a lexical entry. LexInfo is an ontology and thus allows for consistency checking and reasoning. 
...
\subsection{Linguistic formalism}
The linguistic formalism consists of syntactic and semantic part:
\begin{itemize} 
