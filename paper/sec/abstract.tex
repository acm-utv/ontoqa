...
%
% CONCLUSIONS
Our work shows that the grammar to the ontology through the LTAG/DUDES model permits 
high modularization and generalization of the NLP process.
%
Furthermore, such a model suits well to the design of parsing algorithms that can effectively limit both the syntactic and semantic search space.
