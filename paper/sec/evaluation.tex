...
The experimental framework consists in evaluating the perfromance achieved by Ontoqa in terms of response-time and memory usage.
%
...
%
The latter has been measured considering the peak value of peak memory usage recorded by \textit{VisualVM}.
...
\begin{figure}[H]
	...
	\label{fig:evaluation-memory-usage}
\end{figure}